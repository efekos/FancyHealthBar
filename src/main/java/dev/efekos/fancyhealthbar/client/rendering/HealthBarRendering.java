...
public interface HealthBarRendering {
    ...
    void drawPreview(RandomSource random, GuiGraphicsExtractor context, int x, int y, int lines, int lastHealth, int health, boolean blinking, boolean hardcore);
    void draw(RandomSource random, GuiGraphicsExtractor context, Player player, int x, int y, int lines, int regeneratingHeartIndex, float maxHealth, int lastHealth, int health, int absorption, boolean blinking);
